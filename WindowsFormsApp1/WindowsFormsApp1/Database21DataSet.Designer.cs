...
namespace WindowsFormsApp1.Database21DataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `User` (`Username`, `Password`, `Email`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `User` SET `Username` = ?, `Password` = ?, `Email` = ? WHERE ((`ID` = ?))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.Database21ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Username, [Password], Email FROM [User]";
        ...
        public virtual int Fill(Database21DataSet.UserDataTable dataTable) {
        ...
        public virtual Database21DataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database21DataSet.UserDataTable dataTable = new Database21DataSet.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database21DataSet.UserDataTable dataTable) {
